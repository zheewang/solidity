...
bool SyntaxChecker::visit(VariableDeclaration const& _declaration)
{
	...
	{
		if (v050)
			m_errorReporter.syntaxError(_declaration.location(), "Use of var keyword is deprecated.");
		else
			m_errorReporter.warning(_declaration.location(), "Use of var keyword is deprecated.");
	}
	return true;
}
